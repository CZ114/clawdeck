/* I18n for Claude Code Companion (desktop bubble + cards generator).
 *
...
const STRINGS = {
  en: {
    ...
    "bubble.toggleEnabled": "Toggle Companion",
    "bubble.theme": "Theme",
    ...
    "settings.section.companion": "Companion",
    ...
    "consent.body.intro": "Companion will read the past N days of Claude Code session content (your prompts, assistant replies, tool calls + output summaries) and run them through redaction:",
  ...
  zh: {
    ...
    "bubble.context.label": "ctx",
    "bubble.toggleEnabled": "切换 Companion 启用状态",
    "bubble.theme": "主题",
    "bubble.cards": "知识卡片",
    "bubble.settings": "设置",
    "bubble.live": "实时监视",
    ...
    "consent.body.intro": "Companion 会读取过去 N 天的 Claude Code session 内容（你的提问、助手回答、工具调用与输出摘要），过一遍脱敏：",
